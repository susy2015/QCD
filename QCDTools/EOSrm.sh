...
#for i in `xrdfs root://cmseos.fnal.gov/ ls /store/group/lpcsusyhad/hua/Skimmed_2015Nov15 | grep -E 'DeepTrimmd_Spring16_80X_Jul_2016_Ntp_v8p0_new_JEC_new_muonID_top_up_HTMHT-.*root'` 
...
#for i in `xrdfs root://cmseos.fnal.gov/ ls /store/group/lpcsusyhad/hua/Skimmed_2015Nov15 | grep -E 'QCDTFTrimAndSlim_Spring16_80X_Jun_2016_Ntp_v7p0_new_JEC_new_filters_4ifb_QCD_HT.*root'`

...
#for i in `xrdfs root://cmseos.fnal.gov/ ls /store/group/lpcsusyhad/hua/Skimmed_2015Nov15/QCD_Data_2017Moriondv11p3 | grep -E 'QCDTFTrimAndSlim_Spring16_80X_Nov_2016_Ntp_v11p0_new_IDs_TTZTo.*root'` 

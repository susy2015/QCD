...
void SignalDataCard::print_thisSignalDC()
{
  ...
  if (Signalfile.is_open())
  {
    ...
    Signalfile << "lumi_unc_up = "  ; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "lumi_unc_dn = "  ; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "bTagSF_up = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "bTagSF_dn = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "mistagSF_up = " ; for(int i=0;i<NSB;i++){ Signalfile << DC_sb_MC_Signal_systunc[i] << " "; } Signalfile << "\n";
    Signalfile << "mistagSF_dn = " ; for(int i=0;i<NSB;i++){ Signalfile << DC_sb_MC_Signal_systunc[i] << " "; } Signalfile << "\n";
    ...
    Signalfile << "isrUnc_up = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "isrUnc_dn = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "metMag_up = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "metMag_dn = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    ...
    Signalfile << "jetJEC_up = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "jetJEC_dn = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    ...
    Signalfile << "genTopSF_up = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "genTopSF_dn = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "mistaggenTopSF_up = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "mistaggenTopSF_dn = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "data_vs_MC_recoTop_unc_up = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile << "data_vs_MC_recoTop_unc_dn = "; for(int i=0;i<NSB;i++){ Signalfile << 0 << " "; } Signalfile << "\n";
    Signalfile.close();
  }

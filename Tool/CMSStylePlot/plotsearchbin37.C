...
void plotsearchbin37(const TString &fileName = "MCmix_ClosureNewbin.root",
  ...
  for(unsigned int i = 0; i < kNDists; ++i) {
    ...
    hTrue[i]->GetYaxis()->SetTitleSize(0.065);
  ...
  for(unsigned int i = 0; i < kNDists; ++i) {
    ...
    hRatio[i]->GetYaxis()->SetRangeUser(0.0,5.1);
    hRatio[i]->SetTitle("");
    hRatio[i]->SetStats(0);
    ...
    if (i == 0){
      ...
      hRatio[i]->SetAxisRange(0.0,5.1,"Y");
    }
  ...
  */
  ...
  for(unsigned int i = 0; i < kNDists; ++i) {
    ...
    if (i==0){
      ...
      ttext_ntop->DrawLatex(11.5, ymax_Yields/2.5 ,"N_{top} = 1");
      ttext_ntop->DrawLatex(29.5, ymax_Yields/100. ,"N_{top} #geq 2");
      ...
      tl_nb->DrawLine(21,ymin_Yields,21,ymax_Yields/10.); 
      tl_nb->DrawLine(29,ymin_Yields,29,ymax_Yields/400.); 
      ...
      ttext2->DrawLatex( 5.5, ymax_Yields/8., "N_{b} = 1");
      ttext2->DrawLatex(16.0, ymax_Yields/8., "N_{b} #geq 2");
      ...
      tl_mt2->DrawLine(24,ymin_Yields,24,ymax_Yields/800.); 
      tl_mt2->DrawLine(27,ymin_Yields,27,ymax_Yields/800.); 
      tl_mt2->DrawLine(32,ymin_Yields,32,ymax_Yields/800.);
      tl_mt2->DrawLine(35,ymin_Yields,35,ymax_Yields/800.);

...
class LLHadTauFactors
{
 public:
  ...
  double SR_dphi_MC_sb[NSEARCH_BINS] = {0};
  double CR_invdphi_singleMu_MC_sb[NSEARCH_BINS] = {0}, CR_invdphi_singleEl_MC_sb[NSEARCH_BINS] = {0};
  double SR_invdphi_MC_sb[NSEARCH_BINS] = {0};
  //scale factors per search bin
  double dphi_singleMu_Eff_sb[NSEARCH_BINS] = {0}, dphi_singleEl_Eff_sb[NSEARCH_BINS] = {0};
  double invdphi_singleMu_Eff_sb[NSEARCH_BINS] = {0}, invdphi_singleEl_Eff_sb[NSEARCH_BINS] = {0};

...
//                                  NJets =      1        2       3        4        5       6     >=7
const double zinv_NJetRweightingFactor[ZINVNJETS_BINS] = {    0,       0,      0,0.422219,0.792718,0.77479,0.350352};//v13 Data, 35.87 fb-1, all 2016 runs
...
const double zinv_RNorm = 1.070;//v13 Data, 35.87 fb-1

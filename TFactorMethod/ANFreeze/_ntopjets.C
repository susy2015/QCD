...
// ------------>Primitives in pad: 
   ...
   pad->Draw();
   pad->cd();
   pad->Range(-0.625,0,5.625,698.2932);
   pad->SetFillColor(0);
   pad->SetBorderMode(0);
   pad->SetBorderSize(5);
   ...
   h_exp_ntopjets__25->SetBinContent(2,543.0596);
   h_exp_ntopjets__25->SetBinContent(3,29.58897);
   h_exp_ntopjets__25->SetBinContent(4,0.1549601);
   h_exp_ntopjets__25->SetBinError(2,55.47739);
   h_exp_ntopjets__25->SetBinError(3,8.973185);
   h_exp_ntopjets__25->SetBinError(4,0.1549601);
   h_exp_ntopjets__25->SetEntries(532);
   ...
   h_exp_ntopjets__25->GetXaxis()->SetTitle("Number of Top jets");
   h_exp_ntopjets__25->GetXaxis()->SetRange(1,5);
   h_exp_ntopjets__25->GetXaxis()->SetLabelFont(42);
   h_exp_ntopjets__25->GetXaxis()->SetLabelSize(0.035);
   ...
   h_exp_ntopjets__25->GetYaxis()->SetTitleSize(0.065);
   ...
   h_exp_ntopjets__25->Draw("PE1");
   
   TH1D *h_pred_ntopjets_copy__26 = new TH1D("h_pred_ntopjets_copy__26","",20,0,20);
   h_pred_ntopjets_copy__26->SetBinContent(2,542.4369);
   h_pred_ntopjets_copy__26->SetBinContent(3,30.21727);
   h_pred_ntopjets_copy__26->SetBinContent(4,0.1496165);
   h_pred_ntopjets_copy__26->SetBinError(2,14.18673);
   h_pred_ntopjets_copy__26->SetBinError(3,2.743619);
   h_pred_ntopjets_copy__26->SetBinError(4,0.05553176);
   h_pred_ntopjets_copy__26->SetEntries(8602);
   ...
   h_pred_ntopjets_copy__26->GetXaxis()->SetTitle("Number of Top jets");
   h_pred_ntopjets_copy__26->GetXaxis()->SetRange(1,5);
   h_pred_ntopjets_copy__26->GetXaxis()->SetLabelFont(42);
   h_pred_ntopjets_copy__26->GetXaxis()->SetLabelSize(0.035);
   ...
   h_pred_ntopjets_copy__26->GetYaxis()->SetTitleSize(0.065);
   ...
   h_pred_ntopjets__27->SetBinContent(2,542.4369);
   h_pred_ntopjets__27->SetBinContent(3,30.21727);
   h_pred_ntopjets__27->SetBinContent(4,0.1496165);
   h_pred_ntopjets__27->SetBinError(2,14.18673);
   h_pred_ntopjets__27->SetBinError(3,2.743619);
   h_pred_ntopjets__27->SetBinError(4,0.05553176);
   h_pred_ntopjets__27->SetEntries(8602);
   ...
   h_pred_ntopjets__27->GetXaxis()->SetTitle("Number of Top jets");
   h_pred_ntopjets__27->GetXaxis()->SetRange(1,5);
   h_pred_ntopjets__27->GetXaxis()->SetLabelFont(42);
   h_pred_ntopjets__27->GetXaxis()->SetLabelSize(0.035);
   ...
   h_pred_ntopjets__27->GetYaxis()->SetTitleSize(0.065);
...
// ------------>Primitives in pad: ratio
   ...
   Ratio__28->SetBinContent(2,1.001148);
   Ratio__28->SetBinContent(3,0.9792072);
   Ratio__28->SetBinContent(4,1.035715);
   Ratio__28->SetBinError(2,0.1055729);
   Ratio__28->SetBinError(3,0.3099795);
   Ratio__28->SetBinError(4,1.104754);
   Ratio__28->SetMinimum(-2);
   Ratio__28->SetMaximum(5);
   Ratio__28->SetEntries(6.851381);
   ...
   Ratio__28->GetXaxis()->SetTitle("Number of Top jets");
   ...
   Ratio__28->GetXaxis()->SetTitleSize(0.16);
   ...
   Ratio__28->GetYaxis()->SetTitleSize(0.15);
   Ratio__28->GetYaxis()->SetTitleOffset(0.6);

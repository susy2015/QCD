...
void SearchBins::drawSBregionDef(const double ymin_Yields, const double ymax_Yields, const bool logscale)
{
  ...
  if(logscale)
  {
    if(NSB == 59)
    {
      ttext_ntop->DrawLatex(11.5 + adjHalfBin, ymax_Yields/1.5 ,"N_{t} = 1");
      ttext_ntop->DrawLatex(39.5 + adjHalfBin, ymax_Yields/15. ,"N_{t} = 2");
  ...
  if(logscale)
  {
    ttext2->DrawLatex( 4.5 + adjHalfBin, ymax_Yields/2.5, "N_{b} = 1");
    ...
    {
      ttext2->DrawLatex(17.5 + adjHalfBin, ymax_Yields/2.5, "N_{b} = 2");
      ttext2->SetTextAngle(90.);
      ttext2->DrawLatex(23.5  + adjHalfBin, ymax_Yields/10 , "N_{b} #geq 3");
    }
  } 
  else
  {
  ...
  if(logscale)
  {
    ...
    if(NSB == 59)
    {
      ttextmt2->DrawLatex( 2.0, ymax_Yields/30. , "M_{T2}=[200,350]");
      ttextmt2->DrawLatex( 6.0, ymax_Yields/60. , "M_{T2}=[350,450]");
      ttextmt2->DrawLatex( 10.5, ymax_Yields/60. , "M_{T2}#geq450 GeV");
      ttextmt2->DrawLatex( 27.0, ymax_Yields/60. , "M_{T2}#geq350 GeV");
    }
